...
| Planned | platform | auth | [auth](auth/README.md) | [auth tasks](../tasks/features/auth) | 2026-04-14 | Authorization now has its own feature area so role semantics, owner claim, and enforcement boundaries do not get flattened into configuration or control alone. |
