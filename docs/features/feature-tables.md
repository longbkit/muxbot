...
| Active | core | agents | [agents](agents/README.md) | [agents tasks](../tasks/features/agents) | 2026-04-29 | The agents layer now persists session-scoped queue items while keeping runtime ordering and active-run guards inside the agent session model. |
...
| Active | ops | control | [control](control/README.md) | [control tasks](../tasks/features/control) | 2026-04-29 | Control now includes operator queue inspection and creation through `clisbot queues`, alongside runtime, route, loop, and health surfaces. |
